...
/***********************************************************
 * Deliver a deserialization payload to a Spring RMI
 ...
 **********************************************************/
public class RmiInvocationHandlerDeser extends RMIDeserAttack {
	/*******************
	 * Set attack properties.
	 ******************/
	public RmiInvocationHandlerDeser() {
		super();
		this.setDescription("Spring RMI Remoting deserialization");
		...
		this.setRemediationAdvice("[Spring Remoting] " + REMEDIATION_NO_FIX);
	}
	...
	public boolean canAttackEndpoint(RMIEndpoint ep) {
		return ep.hasClass("org.springframework.remoting.rmi.RmiInvocationHandler");
	}
